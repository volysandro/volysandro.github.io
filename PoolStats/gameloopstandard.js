var config = {
  ...
  document.getElementById('player1Name').innerHTML = sessionStorage.getItem('player1fullname');
  document.getElementById('player2Name').innerHTML = sessionStorage.getItem('player2fullname');
  var player1Score = 0;
  var player2Score = 0;
